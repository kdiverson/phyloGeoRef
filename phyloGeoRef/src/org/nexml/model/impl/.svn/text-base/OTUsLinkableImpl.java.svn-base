...
abstract class OTUsLinkableImpl<T> extends SetManager<T> implements
     ...
     * @author rvosa
     */
	protected OTUsLinkableImpl(Document document) {
		super(document);
	}
     ...
     * @author rvosa
     */
	protected OTUsLinkableImpl(Document document, Element item) {
		super(document, item);
	}	

	/*
	 * (non-Javadoc)
	 * @see org.nexml.model.OTUsLinkable#getOTUs()
	 */
	public OTUs getOTUs() {
		return mOTUs;
	}
	...
	/*
	 * (non-Javadoc)
	 * @see org.nexml.model.OTUsLinkable#setOTUs(org.nexml.model.OTUs)
	 */
