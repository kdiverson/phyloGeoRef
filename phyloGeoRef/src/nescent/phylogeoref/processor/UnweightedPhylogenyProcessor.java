...
/**
 * Processes this phylogeny and assigns color and lat/long values to internal nodes.(Unweighted)
 * Also Validates the phylogeny.<br>
 * @author apurv
 */
public class UnweightedPhylogenyProcessor implements PhylogenyProcessor{
    ...
    protected UnweightedPhylogenyProcessor(){
