...
/**
 * Processes this phylogeny and assigns color and lat/long values to internal nodes.(Weighted)
 * Also Validates the phylogeny.<br>
 * @author apurv
 */
public class WeightedPhylogenyProcessor implements PhylogenyProcessor{
    ...
    protected WeightedPhylogenyProcessor(){
        this.weightedAvg = true;
        ...
        for (int i=0; i < numChildren ; i++){
            ...
            if(childDist != null){
                ...
                if(childLat.doubleValue() != UNDEFINED){
                    ...
                    sigmaLat += childLat.doubleValue()*weight;
                    sigmaWt  += weight;
                }
            }
        }
    ...
    private double findMeanChildLongitude(PhylogenyNode node){
        ...
        Vector<Double> timeVector = new Vector<Double>();
        ...
        for (int i=0; i < numChildren ; i++){
            ...
            if(childDist != null){
                ...
                if(childLon.doubleValue() != UNDEFINED){
                    ...
                    timeVector.add(childNode.getDistanceToParent());
                }
            }
